...
SVC
  ...
  log "Descargando el puente v1.7 del repo..."
...
------------------------------------------------------------
 BOTONES NUEVOS arriba en la mini-web:
   ...
   ⚙   Ajustes    — clave/destino + Cuenta, Notificaciones,
       Conexiones y Espacio de Notion en texto, con sus
       botones pulsables desde el telefono
   🪞  Espejo     — la pagina en texto, en vivo
------------------------------------------------------------
